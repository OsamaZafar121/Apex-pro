...
const DallasCleaning = () => {
  const areas = [
    'Downtown Dallas', 'Uptown', 'Deep Ellum', 'Bishop Arts', 'Oak Lawn',
    'Highland Park', 'University Park', 'Lake Highlands', 'Plano', 'Frisco',
  ];
      ...
      <section className="relative bg-gradient-to-r from-[#1169a9] via-[#F08A7F] to-[#F08A7F] py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="inline-block bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full mb-6">
            <span className="text-white font-semibold">🤠 Dallas, TX</span>
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            Best Cleaning Services in Dallas
          </h1>
          <p className="text-xl text-white/90 max-w-2xl mx-auto">
            Professional cleaning for Dallas homes and businesses
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#1169a9] mb-6">
                Dallas's Premier Cleaning Service
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                Serving the greater Dallas-Fort Worth area with professional 
                cleaning services. From downtown high-rises to suburban homes, 
                we deliver exceptional results every time.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                Our local team understands Texas hospitality and the importance 
                of a clean, welcoming space for your family and guests.
              </p>
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-[#1169a9]/10 to-[#F08A7F]/10 rounded-xl p-6">
                  <div className="text-3xl font-bold text-[#1169a9] mb-2">4000+</div>
                  <div className="text-gray-600">Dallas Clients</div>
                </div>
                <div className="bg-gradient-to-br from-[#1169a9]/10 to-[#F08A7F]/10 rounded-xl p-6">
                  <div className="text-3xl font-bold text-[#1169a9] mb-2">DFW</div>
                  <div className="text-gray-600">Metro Area</div>
                </div>
              </div>
            </div>
            <img
              src={officeCleaning}
              alt="Professional cleaning in Dallas"
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: '🏠', title: 'Residential', desc: 'Homes & condos' },
              { icon: '🏢', title: 'Commercial', desc: 'Offices & retail' },
