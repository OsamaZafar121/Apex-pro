...
const NewYorkCleaning = () => {
  const boroughs = [
    'Manhattan', 'Brooklyn', 'Queens', 'The Bronx', 'Staten Island',
    'Upper East Side', 'Upper West Side', 'Midtown', 'Downtown', 'Financial District',
  ];
      ...
      <section className="relative bg-gradient-to-r from-[#1169a9] via-[#F08A7F] to-[#F08A7F] py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            Best Cleaning Services in New York City
          </h1>
          <p className="text-xl text-white/90 max-w-2xl mx-auto">
            Premium cleaning services for NYC apartments, condos, and offices
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#1169a9] mb-6">
                NYC's Premier Cleaning Service
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                Living in New York City means dealing with unique cleaning challenges. 
                From street dust to compact living spaces, our expert cleaners 
                understand the specific needs of NYC homes and businesses.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                We serve all five boroughs with flexible scheduling, including 
                evenings and weekends to fit your busy NYC lifestyle.
              </p>
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-[#1169a9]/10 to-[#F08A7F]/10 rounded-xl p-6">
                  <div className="text-3xl font-bold text-[#1169a9] mb-2">8000+</div>
                  <div className="text-gray-600">NYC Clients</div>
                </div>
                <div className="bg-gradient-to-br from-[#1169a9]/10 to-[#F08A7F]/10 rounded-xl p-6">
                  <div className="text-3xl font-bold text-[#1169a9] mb-2">All 5</div>
                  <div className="text-gray-600">Boroughs Covered</div>
                </div>
              </div>
            </div>
            <img
              src={officeCleaning}
              alt="Professional cleaning in NYC"
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: '🏢', title: 'Apartment Cleaning', desc: 'Studios to penthouses' },
              { icon: '🏬', title: 'Office Cleaning', desc: 'All Manhattan businesses' },
              { icon: '✨', title: 'Deep Cleaning', desc: 'Complete sanitization' },
            ].map((service, index) => (
...
export default NewYorkCleaning;
