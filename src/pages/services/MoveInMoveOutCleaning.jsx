  ...
  const features = [
    {
      ...
      description: 'Start fresh in your new home with a spotless clean before unpacking.',
    },
    {
      icon: '🔑',
      title: 'Move-Out Cleaning',
      description: 'Ensure full deposit return with our thorough move-out service.',
    },
    {
      icon: '🏠',
      title: 'Empty Home Cleaning',
      description: 'Complete cleaning of vacant properties for sale or rent.',
    },
    {
      icon: '✨',
      title: 'Post-Construction',
      description: 'Remove all construction dust and debris after renovations.',
    },
  ];

  const includedServices = [
    'All surfaces dusted and wiped down',
    'Kitchen appliances cleaned inside/out',
    'Cabinets and drawers interior cleaning',
    'Bathrooms fully sanitized and descaled',
  ...
  return (
    <div>
      ...
      <section className="relative bg-gradient-to-r from-[#1169a9] via-[#F08A7F] to-[#F08A7F] py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="inline-block bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full mb-6">
            <span className="text-white font-semibold">📦 Move In/Out Cleaning</span>
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            Stress-Free Move Cleaning Services
          </h1>
          <p className="text-xl text-white/90 max-w-2xl mx-auto">
            Ensure a smooth transition with our comprehensive move-in/move-out cleaning
          </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#F08A7F] font-semibold text-sm uppercase tracking-wider">Flexible Options</span>
            <h2 className="text-3xl md:text-4xl font-bold text-[#1169a9] mb-4 mt-2">
              Move Cleaning Solutions
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Whether you're moving in or out, we've got you covered
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#1169a9] mb-6 mt-2">
                What's Included in Move Cleaning?
              </h2>
              <p className="text-lg text-gray-600 mb-8">
                Our move cleaning service ensures every corner is spotless for a fresh start or full deposit return.
              </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#F08A7F] font-semibold text-sm uppercase tracking-wider">Transparent Pricing</span>
            <h2 className="text-3xl md:text-4xl font-bold text-[#1169a9] mb-4 mt-2">
              Move Cleaning Pricing
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Competitive rates based on property size and condition
            </p>
          </div>
            ...
            {[
              {
                ...
                features: ['2-3 hours', 'All rooms', 'Appliances included', 'Floor care'],
              },
              {
                name: '2-3 Beds',
                price: '$280',
                size: '800-1500 sq ft',
                features: ['3-5 hours', 'All rooms', 'Deep clean kitchen', 'Bathroom descale'],
                popular: true,
              },
              {
                name: '4+ Beds',
                price: '$400+',
                size: '1500+ sq ft',
                features: ['5+ hours', 'All rooms', 'Premium service', 'Custom checklist'],
              },
            ].map((plan, index) => (
              <div
                key={index}
      ...
      <section className="py-24 bg-gradient-to-r from-[#1169a9] via-[#F08A7F] to-[#F08A7F] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
            Moving Soon? Book Your Clean Today!
          </h2>
          <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Get your deposit back or start fresh in your new home
          </p>
