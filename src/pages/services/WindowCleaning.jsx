  ...
  const features = [
    {
      ...
      description: 'Interior and exterior window cleaning for homes of all sizes.',
    },
    {
      icon: '🏢',
      title: 'Commercial Windows',
      description: 'Storefront and office building window cleaning services.',
    },
    {
      icon: '🪟',
      title: 'Screen Cleaning',
      description: 'Remove dirt and grime from window screens for better airflow.',
    },
    {
      icon: '✨',
      title: 'Hard Water Removal',
      description: 'Specialized treatment for hard water stains and mineral deposits.',
    },
  ];

  const includedServices = [
    'Interior glass cleaning (both sides)',
      ...
      <section className="relative bg-gradient-to-r from-[#1169a9] via-[#F08A7F] to-[#F08A7F] py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto">
            Crystal clear windows that let the sunshine in and enhance your view
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Professional results with streak-free shine every time
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Our window cleaning service provides crystal clear results with attention to every detail.
              </p>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-[#1169a9] text-white p-6 rounded-2xl shadow-xl">
                ...
                <div className="text-sm opacity-90">Streak-Free Guarantee</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Competitive pricing based on number and size of windows
            </p>
          </div>
            ...
            {[
              {
                name: 'Small Home',
                price: '$100',
                size: 'Up to 10 windows',
                features: ['Interior & exterior', 'Screen cleaning', 'Track cleaning', 'Sill wiping'],
              },
              {
                name: 'Medium Home',
                price: '$180',
                size: '10-20 windows',
                features: ['All small services', 'Save $20', 'Hard water treatment', 'Priority booking'],
                popular: true,
              },
              {
                name: 'Large Home',
                price: '$280+',
                size: '20+ windows',
                features: ['All medium services', 'Best value', 'Gutter cleaning option', 'Annual contracts'],
              },
            ].map((plan, index) => (
              <div
                key={index}
